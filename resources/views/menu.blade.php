        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" style="background-color: #14b8a6"
                        id="place-order">Pesan</button>
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function attachQuantityControlListeners(parent, menu_name, price) {
                ...
                parent.querySelector('.decrease-quantity').addEventListener('click', function() {
                    if (orderItems[menu_name].quantity > 1) {
                        ...
                        itemCount--;
                        totalPrice -= price;
                        parent.querySelector('.quantity-display').textContent = orderItems[menu_name]
                            .quantity;
                    } else {
            ...
            showBasketButton.addEventListener('click', function() {
                ...
                Object.values(orderItems).forEach(item => {
                    orderSummary.innerHTML +=
                        `<li>${item.menu_name} x${item.quantity} - Rp ${new Intl.NumberFormat('id-ID').format(item.price * item.quantity)}</li>`;
                });
